...
const Alert = () => {
    ...
    }, [events, isPending, account, isError]);// listen to changes in isPending and if account changes
    
    return (
        <div>
        {isPending ? ( //if isPending is true
...
): ! isPending && events[0] ?( //if isPending is false
